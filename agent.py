...
root_agent = LlmAgent(
  ...
  model='gemini-3.5-flash',
  description=(
      'You specialize in the culinary scene. Search for restaurants in the requested area. Identify overhyped TikTok/Instagram tourist traps versus actual local favorite spots with high-quality food.'
  ),
